...
function Calculator() {
    ...
    const handleOperator = (e) => {
        ...
        // if the last inputted digit is not a number stop
        ...
        // Switch for some arithmetic operations
        switch (value) {
            case "ac":
                setOperand("");
                break;
            ...
            <div className='c-wrapper'>
                ...
                <div className='ctc c-screen'>
                    <div className='c-history-answer'>
                        <box-icon name="time" color="white" type="solid"></box-icon><span>{prevAnswer}</span>
                    </div>
            ...
            <span>
              {/* 0 */}
                ...
                <div className='c-grid'>
                    ...
                    <button className="special" value="-" onClick={handleOperator}>&minus;</button>
